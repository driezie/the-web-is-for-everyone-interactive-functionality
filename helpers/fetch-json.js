 ...
 * @example <caption>fetch as returning function using the await keyword</caption>
 * const data = await fetchJson('https://api-url.com/endpoint/')
 * @example <caption>fetch as oneliner using the then() structure.</caption>
 ...
 */
export default async function fetch(url, payload = {}) {
